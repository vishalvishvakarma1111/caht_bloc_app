...
class EventDrawProperties {
  ...
  EventDrawProperties(DayView dayView, MyDayViewEvent event, this.isRTL) {
  ...
  Widget createWidget(BuildContext context, DayView dayView, MyDayViewEvent event) => Positioned(
        top: 5,
        //top
        height: height,
